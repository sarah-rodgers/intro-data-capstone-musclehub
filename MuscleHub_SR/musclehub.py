...
sql_query(''' SELECT * FROM fitness_tests ''')
...
application_mean = np.mean(app_pivot.Application)
print application_mean

tstat, pval = ttest_1samp(app_pivot.Application, 287.5)
print pval
...
testmean = np.mean(member_pivot.Member)

print testmean

tstat2, pval2 = ttest_1samp(member_pivot.Member, 225.0)
print pval2
...
membermean = np.mean(final_member_pivot.Member)

print membermean

tstat3, pval3 = ttest_1samp(final_member_pivot.Member, 225.0)
print pval3
...
x2 = member_pivot.ab_test_group
y2 = member_pivot['Percent Purchase']
...
x3 = final_member_pivot.ab_test_group
y3 = final_member_pivot['Percent Purchase']
